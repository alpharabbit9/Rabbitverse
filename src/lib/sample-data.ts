...
export const projects: Project[] = [
  { id: "p1", name: "Rabbit Verse App", description: "Ship v1 of the life dashboard", targetValue: 100, targetUnit: "%", current: 60, status: "ongoing", startDate: addDays(TODAY, -40), targetDate: addDays(TODAY, -3), tags: ["Full-stack", "Web"], category: "Personal Growth", type: "Full-stack Web App", idea: "A unified life dashboard that brings goals, habits, fitness, finances and mood into one calm, private space — so progress in every area is visible at a glance instead of scattered across half a dozen apps.", goals: "Ship a genuinely useful v1 that gets opened every day: fast, private, dark-mode first, and driven by real data rather than another empty tracker.", keyFeatures: ["Unified life dashboard", "Projects with AI milestones", "Expense & budget tracking", "Workout logging", "Mental-health journal", "Mascot-driven motivation"], problems: ["Life data is scattered across disconnected apps.", "No single view of how the week is actually going.", "Generic trackers feel like a chore and get abandoned."] },
  ...
  { id: "p4", name: "Portfolio Site", description: "Personal portfolio redesign", targetValue: 100, targetUnit: "%", current: 40, status: "ongoing", startDate: addDays(TODAY, -25), targetDate: addDays(TODAY, 5), tags: ["Frontend", "Design"], category: "Design", type: "Frontend", idea: "A refreshed personal portfolio that puts the work first — fast, responsive, and easy to keep current.", goals: "Rebuild the portfolio so adding a new case study takes minutes, and the site scores top marks on performance and accessibility.", keyFeatures: ["Case-study layouts", "Dark / light theme", "MDX content", "Fast static build"], problems: ["The old site was slow and hard to update.", "Projects were buried below a long intro.", "No dark mode."] },
